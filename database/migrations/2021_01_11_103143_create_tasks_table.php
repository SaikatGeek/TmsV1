...
class CreateTasksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tasks', function (Blueprint $table) {
            ...
            $table->enum('status', ['Assigned', 'In Process...', 'In Review', 'Submitted', 'Resubmitted', 'In Revision','Revision Needed','Re Assigned','Tested','Completed','Supervised','Accepted', 'Deprecated'])->nullable();
