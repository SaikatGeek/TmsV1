<div class="container-fluid">
    ...
    @if( (($projectRole == 1) && ($userRole == 2)) || $userRole == 1 )
        ...
        <div class="col-lg-3">
            <div class="card">
                <div class="card-body">
                    <button  type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#AddTask">Add Task</button>
                ...
                <div class="modal-content">
                    <form class="form-horizontal" method="post" action="{{ url('project').'/'.$project_id.'/member/'.$member_id.'/tasks' }}">
                        <div class="modal-header">
                            <h5 class="modal-title" id="scrollableModalTitle">Add Task</h5>
