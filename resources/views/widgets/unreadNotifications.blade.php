    ...
    <div class="card-box">
      <h4 class="header-title"><span class="badge badge-danger"></span>
        <button type="button" class="btn btn-lg btn-danger waves-effect waves-light">
            <span class="btn-label"><i class="mdi mdi-bell-ring-outline"></i></span>{{count($NotificationList)}}
        </button>
      </h4>
            ...
            @foreach($NotificationList as $index => $item)              
              ...
              <div class="card-box mb-2" >
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-1">
                        <div class="text-center my-3 my-sm-0">
                          <img class="d-flex align-self-center mr-3 rounded-square rounded" src="{{ asset($item->image) }}" alt="Created By" height="55">
                        </div>
                    </div>
...
<script type="text/javascript">
    $( document ).ready(function() {
      ...
      function makeRead(){
        ...
        $.ajax({
            type:'POST',
            url:"{{ url('ajax/notifications/make/read') }}",
            data: {_token},
